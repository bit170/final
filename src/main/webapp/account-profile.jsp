    ...
    <header class="navbar navbar-sticky">
      ...
      <div class="site-branding"><a class="site-logo hidden-xs-down" href="index.jsp"><img src="resources/img/logo/logo.png" alt="Unishop"></a><a class="site-logo logo-sm hidden-sm-up" href="index.jsp"><img src="resources/img/logo/logo-sm.png" alt="Unishop"></a>
        <div class="lang-currency-switcher">
          <div class="lang-currency-toggle"><img src="resources/img/flags/GB.png" alt="English"><span>USD</span><i class="material-icons arrow_drop_down"></i>
            <ul class="lang-currency-dropdown">
              ...
              <li><a href="#"><img src="resources/img/flags/FR.png" alt="Français">Français</a></li>
              <li><a href="#"><img src="resources/img/flags/DE.png" alt="Deutsch">Deutsch</a></li>
              <li><a href="#"><img src="resources/img/flags/IT.png" alt="Italiano">Italiano</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <nav class="site-menu">
        <ul>
          <li><a href="index.jsp"><span>Home</span></a>
            <ul class="sub-menu">
              <li class="has-children"><a href="index.jsp"><span>Hero Slider</span></a>
                <ul class="sub-menu w-400 p-0">
                  <li><a class="p-0" href="index.jsp"><img src="resources/img/banners/home01.jpg" alt="Hero Slider Home"></a></li>
                </ul>
              </li>
              <li class="has-children"><a href="home-featured-categories.jsp"><span>Categories Grid</span></a>
                <ul class="sub-menu w-400 p-0">
                  <li><a class="p-0" href="home-featured-categories.jsp"><img src="resources/img/banners/home02.jpg" alt="Categories Grid Home"></a></li>
                </ul>
              </li>
            </ul>
          </li>
          <li><a href="shop-boxed-ls.jsp"><span>Shop</span></a>
            <ul class="sub-menu">
              ...
              <li class="has-children"><a href="shop-boxed-ls.jsp"><span>Shop Layout</span></a>
                <ul class="sub-menu">
          ...
          <li class="active"><a href="account-orders.jsp"><span>Account</span></a>
            <ul class="sub-menu">
                ...
                <li class="active"><a href="account-profile.jsp">Profile Page</a></li>
                <li><a href="account-address.jsp">Contact / Shipping Address</a></li>
                <li><a href="account-tickets.jsp">My Tickets</a></li>
                <li><a href="account-single-ticket.jsp">Single Ticket</a></li>
                <li><a href="account-password-recovery.jsp">Password Recovery</a></li>
            </ul>
          </li>
            ...
            <ul class="mega-menu">
              ...
              <li><span class="mega-menu-title">G - M</span>
                  <ul>
                    ...
                    <li><a href="components/images.jsp">Images &amp; Figures</a></li>
                    <li><a href="components/list-group.jsp">List Group</a></li>
                    <li><a href="components/market-social-buttons.jsp">Market &amp; Social Buttons</a></li>
              ...
              <li><span class="mega-menu-title">P - T</span>
                  <ul>
                    ...
                    <li><a href="components/progress-bars.jsp">Progress Bars</a></li>
              ...
              <li><span class="mega-menu-title">T - W</span>
                  <ul>
                    ...
                    <li><a href="components/tooltips-popovers.jsp">Tooltips &amp; Popovers</a></li>
        ...
        <div class="toolbar-dropdown">
          ...
          <div class="toolbar-section" id="mobileMenu">
            ...
            <nav class="slideable-menu mt-4">
              <ul class="menu">
                <li class="has-children"><span><a href="index.jsp"><span>Home</span></a><span class="sub-menu-toggle"></span></span>
                  <ul class="slideable-submenu">
                      <li><a href="index.jsp">Hero Slider</a></li>
                      <li><a href="home-featured-categories.jsp">Categories Grid</a></li>
                  </ul>
                </li>
                <li class="has-children"><span><a href="shop-boxed-ls.jsp"><span>Shop</span></a><span class="sub-menu-toggle"></span></span>
                  <ul class="slideable-submenu">
                      <li><a href="shop-categories.jsp">Shop Categories</a></li>
                    <li class="has-children"><span><a href="shop-boxed-ls.jsp"><span>Shop Layout</span></a><span class="sub-menu-toggle"></span></span>
                      <ul class="slideable-submenu">
                          <li><a href="shop-boxed-ls.jsp">Boxed Left Sidebar</a></li>
                          <li><a href="shop-boxed-rs.jsp">Boxed Right Sidebar</a></li>
                          <li><a href="shop-boxed-ft.jsp">Boxed Filters Top</a></li>
                      ...
                      <li><a href="shop-single.jsp">Single Product</a></li>
                      <li><a href="cart.jsp">Cart</a></li>
                    <li class="has-children"><span><a href="checkout-address.jsp"><span>Checkout</span></a><span class="sub-menu-toggle"></span></span>
                      <ul class="slideable-submenu">
                          <li><a href="checkout-address.jsp">Address</a></li>
                          <li><a href="checkout-shipping.jsp">Shipping</a></li>
                          <li><a href="checkout-payment.jsp">Payment</a></li>
                ...
                <li class="has-children active"><span><a href="account-orders.jsp"><span>Account</span></a><span class="sub-menu-toggle"></span></span>
                  <ul class="slideable-submenu">
                      <li><a href="account-orders.jsp">Orders List</a></li>
                      <li><a href="account-wishlist.jsp">Wishlist</a></li>
                      <li class="active"><a href="account-profile.jsp">Profile Page</a></li>
                ...
                <li class="has-children"><span><a href="blog.jsp"><span>Blog List</span></a><span class="sub-menu-toggle"></span></span>
                  <ul class="slideable-submenu">
                      <li><a href="blog.jsp">Blog List</a></li>
                      <li><a href="blog-single.jsp">Single Post</a></li>
                  </ul>
                ...
                <li class="has-children"><span><a href="components/accordion.jsp"><span>Components</span></a><span class="sub-menu-toggle"></span></span>
                  <ul class="slideable-submenu">
                      <li><a href="components/accordion.jsp">Accordion</a></li>
                      <li><a href="components/alerts.jsp">Alerts</a></li>
                      <li><a href="components/buttons.jsp">Buttons</a></li>
          ...
          <div class="toolbar-section" id="search">
            ...
            <div class="widget widget-featured-products">
              ...
              <div class="entry">
                ...
                <div class="entry-content">
                  <h4 class="entry-title"><a href="shop-single.jsp">Max <span class='text-highlighted'>Task Chair</span></a></h4><span class="entry-meta">$299.00</span>
                </div>
              </div>
              <!-- Entry-->
              <div class="entry">
                ...
                <div class="entry-content">
                  <h4 class="entry-title"><a href="shop-single.jsp"><span class='text-highlighted'>Drawer</span> File Cabinet</a></h4><span class="entry-meta">$265.00</span>
                </div>
              </div>
              <!-- Entry-->
              <div class="entry">
                ...
                <div class="entry-content">
                  <h4 class="entry-title"><a href="shop-single.jsp">Campfire <span class='text-highlighted'>Paper</span> Table</a></h4><span class="entry-meta">$570.00</span>
                </div>
              </div>
            </div>
            <!-- Blog-->
            <div class="widget widget-featured-products">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="blog-single.jsp"><img src="resources/img/blog/widget/01.jpg" alt="Post"></a></div>
                <div class="entry-content">
                  <h4 class="entry-title"><a href="blog-single.jsp"><span class='text-highlighted'>Modern</span> Working Space</a></h4><span class="entry-meta">May 09</span>
                </div>
              </div>
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="blog-single.jsp"><img src="resources/img/blog/widget/02.jpg" alt="Post"></a></div>
                <div class="entry-content">
                  <h4 class="entry-title"><a href="blog-single.jsp">Interior <span class='text-highlighted'>Design</span> Tricks</a></h4><span class="entry-meta">April 18</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="toolbar-section" id="cart">
            <div class="table-responsive shopping-cart mb-0">
              <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                      <div class="product-item"><a class="product-thumb" href="shop-single.jsp"><img src="resources/img/shop/cart/01.jpg" alt="Product"></a>
                        <div class="product-info">
                          <h4 class="product-title"><a href="shop-single.jsp">3-Drawer File Cabinet</a></h4><span><em>Price:</em> $257.00</span><span><em>Quantity:</em> 1</span>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div class="product-item"><a class="product-thumb" href="shop-single.jsp"><img src="resources/img/shop/cart/02.jpg" alt="Product"></a>
                        <div class="product-info">
                          <h4 class="product-title"><a href="shop-single.jsp">Plastic Tissue Holder</a></h4><span><em>Price:</em> $76.40</span><span><em>Quantity:</em> 2</span>
                        </div>
                      </div>
                    </td>
                    <td class="text-center"><a class="remove-from-cart" href="#"><i class="material-icons icon_close"></i></a></td>
                  ...
                  <tr>
                    <td>
                      <div class="product-item"><a class="product-thumb" href="shop-single.jsp"><img src="resources/img/shop/cart/03.jpg" alt="Product"></a>
                        <div class="product-info">
                          <h4 class="product-title"><a href="shop-single.jsp">Campfire Paper Table</a></h4><span><em>Price:</em> $289.00</span><span><em>Quantity:</em> 1</span>
                        </div>
                      </div>
                    </td>
                    <td class="text-center"><a class="remove-from-cart" href="#"><i class="material-icons icon_close"></i></a></td>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
              <div class="pr-2 py-1 text-sm">Subtotal: <span class='text-dark text-medium'>$622.40</span></div><a class="btn btn-sm btn-success mb-0 mr-0" href="checkout-address.jsp">Checkout</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="page-title">
      <div class="container">
        ...
        <ul class="breadcrumbs">
          ...
          <li><a href="account-orders.jsp">나의 계정</a>
          </li>
          <li class="separator">&nbsp;/&nbsp;</li>
          <li>My Profile</li>
        </ul>
      ...
      <div class="row">
        <div class="col-lg-4">
          <aside class="user-info-wrapper">
            ...
            <div class="user-info">
              <div class="user-avatar"><a class="edit-avatar" href="#"><i class="material-icons edit"></i>수정하기</a><img src="resources/img/account/user-ava.jpg" alt="User"></div>
              <div class="user-data">
                <h5>회원이름</h5><span>Joined November 06, 2020</span>
              </div>
            </div>
          </aside>
          <!-- 마이페이지 목록 수정 (연희) -->
          <nav class="list-group">
            <a class="list-group-item" href="account-wishlist.jsp"><i class="icon-heart"></i>위시리스트<span class="badge badge-default badge-pill">6</span></a>
            <a class="list-group-item" href="account-follows.jsp"><i class="icon-heart"></i>팔로우<span class="badge badge-default badge-pill">3</span></a>
            <a class="list-group-item" href="account-orders.jsp"><i class="icon-heart"></i>주문목록<span class="badge badge-default badge-pill">3</span></a>
            <a class="list-group-item with-badge active" href="account-profile.jsp"><i class="icon-head"></i>프로필 수정</a>
            <a class="list-group-item" href="account-address.jsp"><i class="icon-map"></i>주소록</a>
            <a class="list-group-item" href="account-myCanvas.jsp"><i class="icon-head"></i>마이 캔버스</a>
            </nav>
      </div>
        <div class="col-lg-8">
          ...
          <form class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="account-name" value="Daniel" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="account-ln">닉네임</label>
                <input class="form-control" type="text" id="account-nickname" value="Adams" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="account-phone" value="010 1234 5678" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
