			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="table-responsive shopping-cart mb-0">
						<table class="table">
							...
							<tbody>
								<tr>
									<td>
										<!-- order-tracking page 로 이동 수정 (연희) -->
										<div class="product-item">
											<a class="product-thumb" href="order-tracking.jsp"><img
												src="resources/img/shop/cart/01.jpg" alt="Product"></a>
											<div class="product-info">
												<h4 class="product-title">
													<a href="order-tracking.jsp">3-Drawer File Cabinet<small>x
															1</small></a>
												</h4>
												<span><em>Color:</em> Aqua</span><span><em>Accent
														Color:</em> White</span>
											</div>
										</div>
									</td>
								...
								<tr>
									<td>
										<div class="product-item">
											...
											<div class="product-info">
												<h4 class="product-title">
													<a href="order-tracking.jsp">Plastic Tissue Holder<small>x
															2</small></a>
												</h4>
												<span><em>Size:</em> Medium</span><span><em>Color:</em>
													White</span>
											</div>
										</div>
									</td>
								...
								<tr>
									<td>
										<div class="product-item">
											...
											<div class="product-info">
												<h4 class="product-title">
													<a href="order-tracking.jsp">Campfire Paper Table<small>x
															1</small></a>
												</h4>
												<span><em>Color:</em> Walnut</span><span><em>Accent
														Color:</em> Turquoise</span>
											</div>
										</div>
									</td>
					...
					<div
						...
						<div class="px-2 py-1">
							Subtotal: <span class='text-medium'>$622.40</span>
						</div>
						<div class="px-2 py-1">
							Shipping: <span class='text-medium'>$35.50</span>
						</div>
						<div class="px-2 py-1">
							Tax: <span class='text-medium'>$7.42</span>
						</div>
						<div class="text-lg px-2 py-1">
							Total: <span class='text-medium'>$665.32</span>
						</div>
					</div>
				</div>
			</div>
						...
						<li class="has-children"><a href="index.jsp"><span>Hero
							...
							<ul class="sub-menu w-400 p-0">
								<li><a class="p-0" href="index.jsp"><img
										src="resources/img/banners/home01.jpg" alt="Hero Slider Home"></a></li>
							</ul></li>
