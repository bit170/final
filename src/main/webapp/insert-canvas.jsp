			...
			<ul>
				...
				<li class="active"><a href="shop-boxed-ls.jsp"><span>Shop</span></a>
					<ul class="sub-menu">
						...
						<li class="active has-children"><a
							href="checkout-address.jsp"><span>Checkout</span></a>
							<ul class="sub-menu">
								<li class="active"><a href="checkout-address.jsp">Address</a></li>
				...
				<li><a href="account-orders.jsp"><span>Account</span></a>
					<ul class="sub-menu">
						...
						<ul class="menu">
							...
							<li class="has-children active"><span><a
								...
								<ul class="slideable-submenu">
									...
									<li><a href="shop-single.jsp">Single Product</a></li>
									<li><a href="cart.jsp">Cart</a></li>
									<li class="active has-children"><span><a
			...
			<footer class="site-footer">
				<div class="column text-center">
					<p class="text-sm mb-4">
						Need Support? Call<span class="text-primary">&nbsp;001
							(917) 555-4836</span>
					</p>
					<a class="social-button sb-skype" href="#" data-toggle="tooltip"
						...
						class="social-button sb-google-plus" href="#"
						...
						class="social-button sb-instagram" href="#" data-toggle="tooltip"
