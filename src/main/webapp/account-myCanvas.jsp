			...
			<div class="col-lg-4">
				...
				<nav class="list-group">
					<a class="list-group-item" href="account-wishlist.jsp"> <i
						...
						class="icon-head"></i>프로필 수정
					</a> <a class="list-group-item" href="account-address.jsp"> <i
						class="icon-map"></i>주소록
					</a> <a class="list-group-item with-badge active"
						href="account-myCanvas.jsp"> <i class="icon-head"></i>마이 캔버스
					</a>
